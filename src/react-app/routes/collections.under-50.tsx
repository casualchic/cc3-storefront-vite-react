  ...
  return (
    <div className="min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Under $50</h1>
              ...
              >
                <div className="relative overflow-hidden rounded-lg bg-gray-100 dark:bg-gray-800 aspect-4/5 mb-3 transition-transform duration-300 ease-out group-hover:scale-[1.02]">
                  <img
                    ...
                    loading="lazy"
                  />
                  <div className="absolute top-3 left-3 bg-green-600 text-white px-3 py-1 text-xs font-bold rounded-sm shadow-lg z-10">
                    UNDER $50
                  </div>
                </div>
